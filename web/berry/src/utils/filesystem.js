...
// parent: "" or "/"
export const getFileSystemDirectoryPaths = async (handle, parent = "") => {
    const paths = [];
...
export const createFileSystemDirectory = async (handle, paths) => {
    let cur = handle;
...
export async function verifyFileSystemRWPermission(fileHandle) {
