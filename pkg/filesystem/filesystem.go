...
import (
	...
	"github.com/songquanpeng/one-api/pkg/filesystem/driver"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/cos"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/googledrive"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/local"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/onedrive"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/oss"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/qiniu"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/remote"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/s3"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/shadow/masterinslave"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/shadow/slaveinmaster"
	"github.com/songquanpeng/one-api/pkg/filesystem/driver/upyun"
	"github.com/songquanpeng/one-api/pkg/request"
