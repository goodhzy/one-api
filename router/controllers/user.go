...
func UseGravatar(c *gin.Context) {
	u := CurrentUser(c)
	if err := u.UpdateUser(map[string]interface{}{"avatar": "gravatar"}); err != nil {
...
func UploadAvatar(c *gin.Context) {
	...
	// 保存头像标记
	if err := u.UpdateUser(map[string]interface{}{
		"avatar": "file",
	}); err != nil {
